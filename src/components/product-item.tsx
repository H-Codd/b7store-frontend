  ...
  return (
    <div className="bg-white border border-gray-200 rounded-sm p-6">
      <div className="flex justify-end">
        ...
        >
          {liked && (
            <Image src={`/ui/heart-3-fill.png`} alt="" width={24} height={24} />
          )}
          {!liked && (
            <Image src={`/ui/heart-3-line.png`} alt="" width={24} height={24} />
          )}
        </div>
      </div>
      ...
      <div className="mt-5 text-gray-400">Em ate 12x no cartão</div>
    </div>
  );
};
